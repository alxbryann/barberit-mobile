        ...
        {loading ? (
          ...
          <ScrollView contentContainerStyle={styles.emptyScroll}>
            <Text style={styles.muted}>
              Inicia sesión para ver tus reservas y el historial de citas.
            </Text>
            <TouchableOpacity
          ...
          >
            {err ? (
              ...
              rows.map((r) => {
                const b = r.barberos;
                const nombreBarbero =
                  (b?.nombre_barberia && b.nombre_barberia.trim()) ||
                  (b?.profiles?.nombre && b.profiles.nombre.trim()) ||
                  (b?.slug && b.slug.replace(/-/g, ' ')) ||
                  'Barbero';
                ...
                return (
                  <View key={r.id} style={styles.card}>
                    <Text style={styles.cardTitle} numberOfLines={2}>{nombreBarbero.toUpperCase()}</Text>
